  ...
  tool: {
    ...
    'handoff': {
      ...
      modes: [
        ...
        { m: 'ร่าง handoff doc', dflt: true, d: 'เช็คก่อนเสมอ แล้วร่างเอกสารจาก spec + AC ที่มี', w: 'ออกเอกสาร ไม่แตะไฟล์ Figma', wk: 'safe' }
      ],
      prep: [
      ...
      rules: [
        ...
        'skill นี้ไม่แก้ไฟล์ Figma — จะให้แก้ให้ใช้ ds-audit โหมดแก้',
        'a11y requirement ต้องอยู่ในทุก handoff ไม่ใช่ optional',
        'ระบุ location ทุก issue — "มี hardcode 12 จุด" โดยไม่บอกที่ ใช้ไม่ได้'
      ],
      proof: { ok: false, t: 'ยังไม่เคยรัน', d: 'เขียนไว้ครบแล้วแต่ยังไม่เคยวิ่งจบกับงานจริงสักรอบ — คนแรกที่ลองจะเจอสะดุด ทักได้เลยจะได้แก้' }
    }
  }
};
